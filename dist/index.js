    ...
    async executeToolFunction(name, args) {
        switch (name) {
            ...
            case 'create_damage_skill':
                return await skillTools.createDamageSkill(this.projectPath, args.name, args.damageFormula, args.mpCost, args.scope, args.elementId, args.description);
            case 'create_healing_skill':
                return await skillTools.createHealingSkill(this.projectPath, args.name, args.healFormula, args.mpCost, args.scope, args.description);
            case 'create_buff_skill':
                return await skillTools.createBuffSkill(this.projectPath, args.name, args.buffType, args.turns, args.mpCost, args.scope, args.description);
            case 'create_state_skill':
                return await skillTools.createStateSkill(this.projectPath, args.name, args.stateId, args.chance, args.mpCost, args.scope, args.description);
            case 'update_skill':
            ...
            case 'add_event_command':
                return await mapTools.addEventCommand(this.projectPath, args.mapId, args.eventId, args.pageIndex, args.command, args.position);
            // System Tools
            case 'get_system':
